...
#when you run the program you say "python grabDataMorrison.py PRNs.txt MorrisonCounty.csv". This sets script = grabDataMorrison.py 
#filename = PRNs.txt. and output = MorrisonCounty.csv
