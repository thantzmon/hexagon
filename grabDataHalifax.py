...
#when you run the program you say "python grabDataHalifax.py PRNs.txt HalifaxCounty.csv". This sets script = grabDataHalifax.py 
#filename = PRNs.txt. and output = HalifaxCounty.csv
