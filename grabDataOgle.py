...
#when you run the program you say "python grabDataOgle.py PRNs.txt". This sets script = grabDataOgle.py and 
#filename = PRNs.txt.
...
#sets the file to write to as "Ogle County.csv"
filename = 'Ogle County.csv'
