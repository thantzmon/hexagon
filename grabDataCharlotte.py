...
#when you run the program you say "python grabDataCharlotte.py PRNs.txt". This sets script = grabDataCharlotte.py and 
#filename = PRNs.txt.
...
#sets the file to write to as "Charlotte County.csv"
filename = 'Charlotte County.csv'
